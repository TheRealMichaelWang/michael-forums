...
export class MessageService {
    ...
    public async createForum(title: string, about: string, userId?: string) {
        ...
        return await this.forumDao.createForum(sanitize(title), sanitize(about));
    }
    ...
    public async editForum(id: string, title: string, about: string, userId?: string) {
        ...
        return await this.forumDao.updateForum(id, sanitize(title), sanitize(about));
    }
    ...
    public async createPost(forumId: string, title: string, content: string, userId?: string) {
        ...
        return await this.postDao.createPost(forumId, sanitize(title), sanitize(content), userId!);
    }
    ...
    public async editPost(id: string, title: string, content: string, userId?: string) {
        ...
        return await this.postDao.updatePost(id, sanitize(title), sanitize(content));
    }
    ...
    public async createReply(postId: string, content: string, userId?: string) {
        ...
        return await this.replyDao.createReply(postId, sanitize(content), userId!);
    }
    ...
    public async editReply(id: string, content: string, userId?: string) {
        ...
        return await this.replyDao.updateReply(id, sanitize(content));
    }
